import java.awt.*;
public class NeptuneShield extends Shield {
//    private static int COURT_WIDTH = 300;
//    private static int COURT_HEIGHT = 300;
//    private static int POSITION_X = 225;
//    private static int POSITION_Y = 225;
...
//    private static final int ANGLE_CHANGE = 1;
//    private static Color SHIELD_COLOR = Color.CYAN;
    
    public NeptuneShield(int courtWidth, int courtHeight, Color color, int positionX, int positionY,
